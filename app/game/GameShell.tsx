          ...
          {showCredits ? (
            <>
              ...
              <div className="font-elite mt-8 flex max-w-md flex-col items-center gap-3 text-center text-[13px] leading-6 tracking-[0.12em] text-amber-100/55">
                <p>FableRooms — based on StarKnightt/Backroom-Escape</p>
                <p className="text-amber-100/35">
                  a backrooms of Claude fable 5. every wall, texture, sound
                  and scream is generated by code — no asset files, no level
                  file. each run builds a maze that has never existed before.
                </p>
                <p className="text-fable-green/50 text-[11px] tracking-[0.2em]">
                  lore from nostalgicgarethdev/fablerooms
                </p>
                <p className="text-amber-100/35">
